...
def load_model(
    ...
    **kwargs
    ...
    # Special handling for multi_modality models without handler
...
def _load_janus_model(
    ...
    **kwargs
    ...
    try:
        ...
        logging.info(f"Successfully loaded Janus model from {model_path}")
        return model, processor

    except ImportError as e:
        logging.error(f"Failed to import Janus dependencies: {e}")
        logging.info("Please install: pip install git+https://github.com/deepseek-ai/Janus.git")
        raise
    except Exception as e:
        logging.error(f"Failed to load Janus model: {e}")
        raise
